...
do
    ...
    cluster_cluster_port_conf="CLUSTER_CLUSTER_PORT_${id}"
    ...
    cluster_cluster_port=`grep $cluster_cluster_port_conf $template_file | awk -F '=' '{print $2}'`
    ...
    echo "  Cluster_Port: $cluster_cluster_port"
    ...
    sed "s/COMMON_CLUSTER_PORT_PLACEHOLDER/${cluster_port}/g" -i $conf_file
    sed "s/CLUSTER_CLUSTER_PORT_PLACEHOLDER/${cluster_cluster_port}/g" -i $conf_file
